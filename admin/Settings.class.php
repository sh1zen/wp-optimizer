...
class Settings
{
    ...
    {
        $mod_handler = ModuleHandler::getInstance();
    ...
    private static function generateHTML_tabpan($modules)
    {
        ...
        foreach ($modules as $module) {
            ...
            $object = ModuleHandler::get_module_instance($module);
    ...
    public function activate()
    {
        ...
        if (!$options or empty($options)) {
             ...
             */
            ModuleHandler::getInstance()->setup_modules('all');
    ...
    public function validate($input)
    {
        ...
        $object = ModuleHandler::get_module_instance($input['change']);
