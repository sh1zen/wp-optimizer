...
class WOOptions
{
    public static function update($option, $value = false)
    {
        ...
        WOCache::getInstance()->set_cache($option, $value, 'options', true);
    ...
    public static function get($option, $default = false)
    {
        ...
        if ($value = WOCache::getInstance()->get_cache($option, 'options', false))
            return $value;
        ...
        if (is_object($row)) {
            ...
            WOCache::getInstance()->set_cache($option, $value, 'options');
        }
        else {
            $value = $default;
        }
