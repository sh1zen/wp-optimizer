<?php
/**
 * WP-CLI commands for WP Optimizer
 */
...
class wpoptCLI extends \WP_CLI_Command
{
    ...
    public function clear( $args, $args_assoc ) {
        WP_CLI::line( esc_html__( 'Flushing the cache...', 'wpopt' ) );
        wpoptCache::clearall();
        WP_CLI::success( esc_html__( 'Cache flushed.', 'wpopt' ) );
    }
}

WP_CLI::add_command( 'clearcache', 'wpoptCLI' );
