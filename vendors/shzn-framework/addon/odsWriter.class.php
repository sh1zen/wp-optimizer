...
class odsWriter
{
    ...
    private function getMetaXML()
    {
        ...
        $generator = $this->dom->createElement('meta:generator', 'SHZN-odsWriter/1.0');
        ...
        $creationDate = $this->dom->createElement('meta:creation-date', date('Y-m-d\TH:i:s\Z', shzn_time()));
        $meta->appendChild($creationDate);

        $dcDate = $this->dom->createElement('dc:date', date('Y-m-d\TH:i:s\Z', shzn_time()));
