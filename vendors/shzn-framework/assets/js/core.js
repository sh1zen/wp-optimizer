...
(function ($, window, noGlobal) {
    ...
    shzn.fn.extend({
        ...
        TextBoxHighlighter: function (options) {
            return this.each(function () {
                let $this = $(this),
                    plugin = $this.data(shzn.ui.textBoxHighLighter.id);

                if (plugin) {
                    plugin.destroy();
                }

                plugin = shzn.ui.textBoxHighLighter.init($this, options);

                if (plugin.isGenerated) {
                    $this.data(shzn.ui.textBoxHighLighter.id, plugin);
                }
    ...
    shzn.ui = {
        ...
        textBoxHighLighter: {
            ...
            generate: function () {
                this.$el
                    .addClass(shzn.ui.textBoxHighLighter.id + '-input ' + shzn.ui.textBoxHighLighter.id + '-content')
                    .on('input.' + shzn.ui.textBoxHighLighter.id, this.handleInput.bind(this))
                    .on('scroll.' + shzn.ui.textBoxHighLighter.id, this.handleScroll.bind(this));

                this.$highlights = $('<div>', {class: shzn.ui.textBoxHighLighter.id + '-highlights ' + shzn.ui.textBoxHighLighter.id + '-content'});

                this.$backdrop = $('<div>', {class: shzn.ui.textBoxHighLighter.id + '-backdrop'})
                    .append(this.$highlights);

                this.$container = $('<div>', {class: shzn.ui.textBoxHighLighter.id + '-container'})
                    .insertAfter(this.$el)
            ...
            destroy: function () {
                ...
                this.$el
                    .unwrap()
                    .removeClass(shzn.ui.textBoxHighLighter.id + '-text ' + shzn.ui.textBoxHighLighter.id + '-input')
                    .off(shzn.ui.textBoxHighLighter.id)
                    .removeData(shzn.ui.textBoxHighLighter.id);
            },
        },
