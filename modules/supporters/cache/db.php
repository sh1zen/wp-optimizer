...
require_once WP_PLUGIN_DIR . '/wp-optimizer/inc/constants.php';
require_once WP_PLUGIN_DIR . "/wp-optimizer/inc/Storage.class.php";
...
class WPOPT_DB extends wpdb
{
    ...
    public function get_var($query = null, $x = 0, $y = 0)
    {
        ...
        $result = Storage::getInstance()->get($key, self::get_cache_group());
        ...
        if (!$result) {
            ...
            if ($this->timer_stop() > WPOPT_CACHE_DB_THRESHOLD_STORE) {
                Storage::getInstance()->set($result, self::get_cache_group(), $key, $this->db_lifespan);
            }
        }
