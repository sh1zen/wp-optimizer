...
/**
 * List Table API: WO_OM_List_Table class
 ...
 * @see \WP_List_Table
 */
class Optimize_Media_Table extends \WP_List_Table
{
    ...
    {
        global $mode, $wp_query, $post_mime_types;
    ...
    {
        if ($this->is_trash) {
            _e('No media files found in Trash.', 'wpopt');
        }
        else {
    ...
    protected function handle_row_actions($post, $column_name, $primary)
    {
        ...
        return $this->row_actions($this->_get_row_actions($post, 'title_lklkl'));
    }
