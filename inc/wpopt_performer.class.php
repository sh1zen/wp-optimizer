...
class wpopt_performer
{
    ...
    private function opti_images_dir($path)
    {
        ...
        if (PHP_OS === 'WINNT') {
            $gifsicle_src = escapeshellarg(WPOPT_ABSPATH . '/inc/executables/' . 'gifsicle.exe');
            $optipng_src = escapeshellarg(WPOPT_ABSPATH . '/inc/executables/' . 'optipng.exe');
            $jpegtran_src = escapeshellarg(WPOPT_ABSPATH . '/inc/executables/' . 'jpegtran.exe');
            $pngquant_src = escapeshellarg(WPOPT_ABSPATH . '/inc/executables/' . 'pngquant.exe');
            $webp_src = escapeshellarg(WPOPT_ABSPATH . '/inc/executables/' . 'cwebp.exe');
        }
        elseif (PHP_OS === 'Darwin') {
            $gifsicle_src = escapeshellarg(WPOPT_ABSPATH . '/inc/executables/' . 'gifsicle-mac');
            $optipng_src = escapeshellarg(WPOPT_ABSPATH . '/inc/executables/' . 'optipng-mac');
            $jpegtran_src = escapeshellarg(WPOPT_ABSPATH . '/inc/executables/' . 'jpegtran-mac');
            $pngquant_src = escapeshellarg(WPOPT_ABSPATH . '/inc/executables/' . 'pngquant-mac');
            $webp_src = escapeshellarg(WPOPT_ABSPATH . '/inc/executables/' . 'cwebp-mac14');
        }
        elseif (PHP_OS === 'SunOS') {
            $gifsicle_src = escapeshellarg(WPOPT_ABSPATH . '/inc/executables/' . 'gifsicle-sol');
            $optipng_src = escapeshellarg(WPOPT_ABSPATH . '/inc/executables/' . 'optipng-sol');
            $jpegtran_src = escapeshellarg(WPOPT_ABSPATH . '/inc/executables/' . 'jpegtran-sol');
            $pngquant_src = escapeshellarg(WPOPT_ABSPATH . '/inc/executables/' . 'pngquant-sol');
            $webp_src = escapeshellarg(WPOPT_ABSPATH . '/inc/executables/' . 'cwebp-sol');
        }
        elseif (PHP_OS === 'FreeBSD') {
            $gifsicle_src = escapeshellarg(WPOPT_ABSPATH . '/inc/executables/' . 'gifsicle-fbsd');
            $optipng_src = escapeshellarg(WPOPT_ABSPATH . '/inc/executables/' . 'optipng-fbsd');
            $jpegtran_src = escapeshellarg(WPOPT_ABSPATH . '/inc/executables/' . 'jpegtran-fbsd');
            $pngquant_src = escapeshellarg(WPOPT_ABSPATH . '/inc/executables/' . 'pngquant-fbsd');
            $webp_src = escapeshellarg(WPOPT_ABSPATH . '/inc/executables/' . 'cwebp-fbsd');
        }
        else { //if ( PHP_OS === 'Linux' ) {
            $gifsicle_src = escapeshellarg(WPOPT_ABSPATH . '/inc/executables/' . 'gifsicle-linux');
            $optipng_src = escapeshellarg(WPOPT_ABSPATH . '/inc/executables/' . 'optipng-linux');
            $jpegtran_src = escapeshellarg(WPOPT_ABSPATH . '/inc/executables/' . 'jpegtran-linux');
            $pngquant_src = escapeshellarg(WPOPT_ABSPATH . '/inc/executables/' . 'pngquant-linux');
            $webp_src = escapeshellarg(WPOPT_ABSPATH . '/inc/executables/' . 'cwebp-linux');
        }
