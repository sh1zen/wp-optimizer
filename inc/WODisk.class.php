...
class WODisk
{
    ...
    public static function autocomplete($path = '')
    {
        ...
        $abspath = WO_UtilEnv::normalize_path(ABSPATH, true);

        $_search_path = WO_UtilEnv::normalize_path($abspath . $path, true);
        ...
        $search_path = WO_UtilEnv::normalize_path($search_path, true);
